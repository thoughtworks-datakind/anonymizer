...
class TestPIIDetector(TestCase):
    ...
    def test_should_detect_nric_in_text(self):
        results = PIIDetector.analyze("First President of Singapore, Yusof bin Ishak's NRIC was S0000001I")
        self.assertEqual("The text S0000001I at position(57,66) was identified as NRIC", results[0])
    ...
    def test_should_detect_nric_and_email_in_text(self):
        ...
        self.assertEqual("The text S0000001I at position(57,66) was identified as NRIC", results[0])
        self.assertEqual("The text test@sample.com at position(154,169) was identified as Email", results[1])
